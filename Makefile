...
OFILES = gba.o font.o main.o menu.o play.o draw.o images/background.o images/player.o images/red_coin.o images/yellow_coin.o images/about.o images/menu_background.o
